...
`,
  ...
  "footer.greenSoftware":
    "🌱 تم إنشاء الموقع باستخدام مبادئ البرمجيات الخضراء: محسن لكفاءة الطاقة وتقليل البصمة الكربونية.",
  "footer.ipDisclaimer":
    "العلامة التجارية 'Teoria da Permissão' ونظام 'Aliança Divergente' هي ملكية فكرية لـ Elton Euler. هذه البوابة هي مبادرة مستقلة من حليف رسمي لأغراض الدراسة.",
